            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel disabled-panel">
                        <div class="x_title">
                            <h2>Thêm Danh Mục Mới<small style="color: red">(Hiện tại đã có 5 danh mục, và không cần thiết phải thêm vì nó đã đầy đủ với chức năng của website rồi.)</small></h2>
