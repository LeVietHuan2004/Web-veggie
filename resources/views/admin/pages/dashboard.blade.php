                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $badgeClasses = [
                                                    Order::STATUS_PENDING => 'custom-badge badge badge-warning',
                                                    Order::STATUS_PROCESSING => 'custom-badge badge badge-primary',
                                                    Order::STATUS_READY_FOR_DELIVERY => 'custom-badge badge badge-info',
                                                    Order::STATUS_OUT_FOR_DELIVERY => 'custom-badge badge badge-info',
                                                    Order::STATUS_DELIVERED => 'custom-badge badge badge-success',
                                                    Order::STATUS_COMPLETED => 'custom-badge badge badge-success',
                                                    Order::STATUS_CANCELED => 'custom-badge badge badge-danger',
                                                ];
                                                $badgeClass =
                                                    $badgeClasses[$status] ?? 'custom-badge badge badge-secondary';
                                            @endphp
                                            <span
                                                class="{{ $badgeClass }}">{{ $statusLabels[$status] ?? ucfirst(str_replace('_', ' ', $status)) }}</span>
                                        </td>
