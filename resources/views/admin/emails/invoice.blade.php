...
<body style="font-family: Arial, sans-serif; font-size: 16px; color: #333; line-height: 1.6; margin: 0; padding: 20px; background-color: #f9f9f9;">
    <div style="max-width: 700px; margin: 0 auto; background: #fff; padding: 20px; border-radius: 8px;">
        ...
        <table style="width: 100%; margin-bottom: 20px;">
            <tr>
                ...
                <td>
                    <strong>Đến:</strong>
                    <p>Veggie Shop<br>
                    Le Thuy, Quang Binh<br>
                    Số điện thoại: 1 (804) 123-9876<br>
                    Email: huanlee2004@gmail.com</p>
                </td>
                <td>
        ...
        <p style="background: {{ $order->payment->payment_method == 'paypal' ? 'blue' : 'green' }}; color: #fff; padding: 10px; text-align: center; border-radius: 5px;">
            {{ $order->payment->payment_method == 'paypal' ? 'Thanh toán bằng PayPal' : 'Thanh toán khi nhận hàng' }}
        </p>
        <p style="font-size: 14px; color: #777;">Nếu là PayPal, thanh toán đã được xử lý trực tuyến. Nếu là thanh toán khi nhận hàng, khách hàng sẽ thanh toán khi nhận sản phẩm.</p>
