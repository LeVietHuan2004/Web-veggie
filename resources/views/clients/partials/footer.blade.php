                        ...
                        <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                            <div class="footer-widget footer-about-widget">
                                <div class="footer-logo">
                                    <div class="site-logo">
                                        <a href="\"><img src="{{ asset('assets/clients/img/logo.png') }}"
                                            alt="Logo"></a>
                                    </div>
                                </div>
                                <p>Veggie mang đến rau củ quả tươi ngon, an toàn và chất lượng, trực tiếp từ nông trại
                                    đến bàn ăn của bạn.</p>
                                ...
                                <div class="footer-address">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="footer-address-info">
                                        <p><a href="mailto:huanlee2004@gmail.com">huanlee2004@gmail.com</a>
                                                </p>
                                            </div>
                                        </li>
                                    </ul>
